...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TFile *inputSig(0);
   TString fnameSig = "/Users/nathanjay/Desktop/SURF/configs/";
   inputSig = TFile::Open( fnameSig ); // check if file in local directory exists
   TFile *inputBkg(0);
   TString fnameBkg = "/Users/user/ldmx-tracking/LDMX-Nov2023/ALP/script_produciton/PN_ntuple.root";
   ...
   dataloader->AddVariable( "NHits", 'I' );
